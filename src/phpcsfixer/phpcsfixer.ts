...
import { PHPCSFixerConfig } from './phpcsfixer.d'
...
class PHPCSFixer extends PHPCSFixerConfig {
    ...
    loadSettings() {
        ...
        this.executablePath = this.resolveVscodeExpressions(
            this.executablePath
        );
        ...
        this.config = '.php-cs-fixer.dist.php';
        ...
        if (this.executablePath.endsWith(".phar")) {
            ...
            this.executablePath = workspace
                .getConfiguration("php")
                .get("validate.executablePath", "php");
        ...
        this.editorFormatOnSave = workspace
